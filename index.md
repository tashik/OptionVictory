...
### Версия от 10 июня 2023 г (АКТУАЛЬНАЯ)
[ovic-2.3.4](https://github.com/tashik/OptionVictory/archive/refs/tags/ovic-2.4.zip) Поддержка разной точности цен опционов и базовых активов на них, позволяющая правильно учитывать и моделировать позиции в опционах на юань и природный газ, а также акционы типа ВТБ. Потребуется после колонок Код класса и Лот в таблицу текущих торгов добавить колонку Точность (внимание! не Точность к-ва: а просто Точность). Для релиза достаточно инкрементной установки с версии 2.3.8

Для инкрементной установки с версии 2.3.8 просто заменяем OptionFVV.exe и OptionFVV.pdb на те, что в релизе.
https://github.com/tashik/OptionVictory/archive/refs/tags/ovic-2.4.zip
